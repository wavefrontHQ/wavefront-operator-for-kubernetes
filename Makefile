...
controller-gen:
	k8po go-get-tool $(CONTROLLER_GEN) sigs.k8s.io/controller-tools/cmd/controller-gen@v0.8.0
...
envtest: ## Download envtest-setup locally if necessary.
	k8po go-get-tool $(ENVTEST) sigs.k8s.io/controller-runtime/tools/setup-envtest@latest
